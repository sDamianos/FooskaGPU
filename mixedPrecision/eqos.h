__device__ __forceinline__ float eqos(INPUT *d_input, int imat, int idVar3, float val1, float val2){
...
__device__ __forceinline__ double eqosDouble(INPUT *d_input, int imat, int idVar3, double val1, double val2){
