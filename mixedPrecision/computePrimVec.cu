...
__global__ void convert2PrimVecProx(INPUT *d_input, int start, int nFcs, int *fc2el, double *consVec, double *primVecF, int max, int *neigRank4fc, int *lclProx4fc, float *sendBuff){
