				...
				for(int iv = 0; iv < nEl4GlbNd[ignd]; iv++){
					...
					if(iel1 != iel){
						for(int ifc1 = 0; ifc1 < nFaces[iel1]; ifc1++){
							if( fabs(fcCenter[iel*6*3 + ifc*3 + 0] - fcCenter[iel1*6*3 + ifc1*3 + 0]) < 1e-8 && fabs(fcCenter[iel*6*3 + ifc*3 + 1] - fcCenter[iel1*6*3 + ifc1*3 + 1]) < 1e-8 && fabs(fcCenter[iel*6*3 + ifc*3 + 2] - fcCenter[iel1*6*3 + ifc1*3 + 2]) < 1e-8){
								neig[iel*6+ifc] = iel1;
