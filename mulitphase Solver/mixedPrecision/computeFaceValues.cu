...
__global__ void updateFacesProx(INPUT *d_input, int start, int nFcs, int max, int *fc2el, int *neigRank4fc, int *lclProx4fc, float *theta, float *extensionVec, double *primVecF, double *sendBuff){
