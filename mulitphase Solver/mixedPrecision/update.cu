...
__global__ void rk3stage1(INPUT *d_input, int nElem, float dt, float *volume, float *RHS, double *consVec0, double *consVec){
...
__global__ void rk3stage2(INPUT *d_input, int nElem, float dt, float *volume, float *RHS, double *consVec0, double *consVec){
...
__global__ void rk3stage3(INPUT *d_input, int nElem, float dt, float *volume, float *RHS, double *consVec0, double *consVec){
...
__global__ void rungeKutta(INPUT *d_input, int nElem, float dt, float *volume, float *RHS, double *consVec){
	...
	while(iel < nElem){
		...
		//if(isnan(consVec[iel*10 + iVar])==1){printf("iel %d iVar %d ConsVec %.10le\n", iel,iVar, consVec[iel*10 + iVar]);}
