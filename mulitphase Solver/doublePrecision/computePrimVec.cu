...
__global__ void convert2PrimVec(INPUT *d_input, int start, int nFcs, int *fc2el, int *boundCond,  double *n, double * nt1, double *nt2, double *consVec, double *primVecF){
